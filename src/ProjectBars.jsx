  ...
  return (
    <div className="relative">
      ...
      <div className="flex justify-center items-center bg-gray-200 w-[300px] h-[43px] mx-[auto] gap-[58px] items-center rounded-[20px] justify-between md:w-[420px] h-[43px] gap-[87px] mx-[auto] ">
        <div className="flex justify-center text-black items-center cursor-pointer rounded-[20px] w-[178px] h-[43px] py-[0px] bg-amber-500 text-center font-bold md:h-[43px]"
          id="frontend-dragbar"
        >
          Frontend
        </div>
        <div className="flex justify-center text-black items-center cursor-pointer rounded-[20px] w-[178px] h-[29px] py-[0px] bg-gray-200 text-center font-bold md:h-[43px]" id="ui-dragbar">
          UI/UX
        </div>
      </div>
    </div>
