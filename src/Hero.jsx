...
function Hero() {
  return (
    <>
        <img className='w-[106px] absolute top-[300px]' src='./src/Graphics/pattern.svg' />
        <div className='w-[100vw] flex flex-col justify-center items-center mt-[150px] md:flex-row-reverse px-[147px] gap-[133px] justify-center items-center'>
            <div className='flex justify-center items-center'>
                    <img className='w-[281px] h-[200px] md:w-[412.11px] h-[293.28px]' src='./src/Graphics/man.svg' />
            </div>
        ...
        <div className='flex justify-center items-center mt-[32.7px]'>
            <img className='w-[32px] md:w-[40.34px]' src='./src/Graphics/Dribbble.svg' />
            <img className='w-[32px] md:w-[40.34px]' src='./src/Graphics/Github.svg' />
        </div>
    </>
  )
}
