...
function Card(props) {
  return (
    <div className='text-black w-[285px] bg-gray-200 rounded-[10px] flex flex-col justify-center items-center'>
        ...
        <div className='flex justify-center items-center mx-[83px] gap-[19.4px] mt-[20px] mb-[32px]'>
            <a href={props.link} ><img className='cursor-pointer w-[22.03px]' src={props.icon} /></a>
