    ...
    <div className='flex flex-col gap-y-1 justify-center items-center md:flex-row gap-[181.93px]'>
        ...
        <div className='flex flex-col justify-center items-center text-center px-[52px] mt-[] md:grid justify-items-start '>
            ...
            <div className='text-center md:text-left'>
                <span className='text-[23px] font-bold mt-[20px] md:text-[49px]'>I'm Temidayo Afolabi </span><br></br><span className='text-[16px] font-bold md:text-[33px]'>(AfoDyDigitals)</span>
            </div>
            <div className='text-[14px] font-normal md:text-[26px] text-left mt-[17px]'>
                I specialise in identifying user needs and creating<br></br> accessible user interfaces and usable frontend designs
            </div>
