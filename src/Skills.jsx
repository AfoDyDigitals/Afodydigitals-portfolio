...
function Skills(props) {
  return (
    <div className="mt-[50px]  flex flex-col justify-center items-center md:h-[]">
      ...
      <div className="animate-pulse gap-[40px] columns-5 mt-[30px] mx-[59px] mb-[32px] md:flex justify-center gap-[70px]  mb-[32px]">
        <img
          className="w-[32px] md:w-[43.71px] h-[43.62px]"
          src="./Graphics/CSS.svg"
        />
        <img
          className="w-[32px] md:w-[32px] h-[43.62px]"
          src="./Graphics/Wordpress.svg"
        />
        <img
          className="w-[32px] md:w-[43.71px] h-[43.62px]"
          src="./Graphics/React.svg"
        />
        <img
          className="w-[32px] md:w-[43.71px] h-[43.62px]"
          src="./Graphics/Tailwind.svg"
        />
        <img
          className="w-[32px] md:w-[73.12px] h-[43.71px]"
          src="./Graphics/Figma.svg"
        />
        <img
          className="w-[32px] md:w-[43.71px] h-[43.62px]"
          src="./Graphics/AdobePhotoshop.svg"
        />
        <img
          className="w-[32px] md:w-[43.71px] h-[43.62px]"
          src="./Graphics/javascript.svg"
        />
        <img
          className="w-[32px] md:w-[43.71px] h-[43.62px]"
          src="./Graphics/AdobeXD.svg"
        />
        <img
          className="w-[32px] md:w-[43.71px] h-[43.62px]"
          src="./Graphics/HTML5.svg"
        />
        <img
          className="w-[32px] md:w-[43.71px] h-[43.62px]"
          src="./Graphics/AdobeIllustrator.svg"
        />
      </div>
